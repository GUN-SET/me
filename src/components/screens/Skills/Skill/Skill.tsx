...
const Skill = ({ directionLeft, skill }: ISkill) => (
  <div className="group relative flex cursor-pointer">
    ...
    <motion.div
      ...
      transition={{ duration: 1 }}
      whileInView={{ x: 0 }}
      className="absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white h-24 w-24 md:h-28 md:w-28 xl:w-32 xl:h-32 rounded-full z-0"
    >
